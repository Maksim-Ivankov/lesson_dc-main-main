...
js_1 = ft.Container(
    ft.Column(controls=[
        ...
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_08-38-42.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_08-45-17.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_08-45-46.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_08-48-26.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_08-52-25.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_08-52-41.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_08-59-20.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_09-00-08.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_09-23-22.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_09-24-11.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Text('Зайдите на сайт, введите значения в инпуты и нажмите кнопку. Посмотрите, что получится.'),width=700),
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_09-26-02.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_09-32-51.png',width=700),margin=ft.margin.only(left=0)),
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_09-33-21.png',width=700),margin=ft.margin.only(left=0)),
        ...
        ft.Container(ft.Image(src='src/pages/content/web_page/img/js/2024-11-15_09-38-34.png',width=700),margin=ft.margin.only(left=0)),
